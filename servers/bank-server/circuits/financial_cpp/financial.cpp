...
void FinancialVerification_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void FinancialVerification_3_run(uint ctx_index,Circom_CalcWit* ctx);
Circom_TemplateFunction _functionTable[4] = { 
Num2Bits_0_run,
LessThan_1_run,
GreaterThan_2_run,
FinancialVerification_3_run };
...
FinancialVerification_3_create(1,0,ctx,"main",0);
FinancialVerification_3_run(0,ctx);
}
