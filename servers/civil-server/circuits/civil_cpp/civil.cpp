...
void CivilVerification_5_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void CivilVerification_5_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 546;}
...
GreaterThan_2_create(mySignalStart+13,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "maritalStatusCheck";
IsEqual_4_create(mySignalStart+279,5+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 5+ctx_index+1;
}
{
std::string new_cmp_name = "monthlyIncomeCheck";
GreaterThan_2_create(mySignalStart+285,7+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 7+ctx_index+1;
}
{
std::string new_cmp_name = "criminalRecordCheck";
IsEqual_4_create(mySignalStart+273,3+ctx_index+1,ctx,new_cmp_name,myId);
...
CivilVerification_5_create(1,0,ctx,"main",0);
CivilVerification_5_run(0,ctx);
}
